...
function disableControls(){
	(pageEnd) ? console.log("Page ENDED") : pointer.style.display = "block";
	mute_btn.style.visibility = "visible";
	unmute_btn.style.visibility = "hidden";
	play_btn.style.visibility = "visible";
	pause_btn.style.visibility = "hidden";
...
function nextPage() {
	...
	if(currentChapter == 1){
		...
		if(currentChapterPage[currentChapter-2] == pageCurrent){
			...
			document.getElementById('progress-title').innerHTML = chapterTitles[currentChapter-1];
		}
		var currentpage = currentChapterPage[currentChapter-1];
		aud.src = 'audio/' + soundContentHolder[currentChapter-1][currentpage] +'.mp3';
		Iframe.src = "./pages/" + pagesContentHolder[currentChapter-1][currentpage] + ".html";
...
function backPage() {
	...
	if(currentChapter==1){
		...
		if(currentChapterPage[currentChapter-1] == 1){
			...
			document.getElementById('progress-title').innerHTML = chapterTitles[currentChapter-2];
